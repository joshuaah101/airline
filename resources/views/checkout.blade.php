...
<body class="bg-gray-100">
    <header class="h-1/2 shadow-2xl bg-green-800 bg-opacity-75">
    ...
    <main class="mt-8" id="main">
       <!-- <div class="flex justify-around justify-between xs:flex-col sm:flex-row">
            {{-- personal information card --}}
            <div class="h-auto w-8/12 bg-white p-8 rounded shadow-2xl">
                <div class="text-2xl font-sans font-semibold">
                    Fill in your checkout information
                </div>
                <form action="" method="post" class="mt-5 flex flex-col" id="">
                    ...
                    <div class="-ml-3">
                        <div class="flex mt-3">
                            <div class="p-3">
                                ...
                                <input type="text" name="surname" id="surname" placeholder="Enter surname" class="px-2 py-1 bg-white placeholder-gray-700 border-b-4 focus:border-0 focus:outline-none mt-2" />
                            </div>
                            <div class="p-3">
                                <label class="text-sm text-gray-700 font-bold">
                                    First name
                                </label>
                                <input type="text" name="first_name" id="first_name" placeholder="Enter first name" class="px-2 py-1 bg-white placeholder-gray-700 border-b-4 focus:border-0 focus:outline-none mt-2" />
                            </div>
                            <div class="p-3">
                                <label class="text-sm text-gray-700 font-bold">
                                    Middle name
                                </label>
                                <input type="text" name="mid_name" id="mid_name" placeholder="Enter middle name" class="px-2 py-1 bg-white placeholder-gray-700 border-b-4 focus:border-0 focus:outline-none mt-2" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="-ml-3">
                        <div class="mt-3">
                            <div class="p-3">
                                ...
                                <select name="sex" id="sex" class="px-2 py-1 bg-white border-b-4 focus:border-0 focus:outline-none mt-2 w-full appearance-none">
                    ...
                    <div class="-ml-3">
                        <div class="flex mt-3">
                            <div class="p-3">
                                ...
                                <input type="tel" name="phone_number" id="phone_number" placeholder="Phone number" class="px-2 py-1 bg-white placeholder-gray-700 border-b-4 focus:border-0 focus:outline-none mt-2" />
                            </div>
                            <div class="p-3">
                                <label class="text-sm text-gray-700 font-bold">
                                    State
                                </label>
                                <input type="text" name="state" id="state" placeholder="Enter state" class="px-2 py-1 bg-white placeholder-gray-700 border-b-4 focus:border-0 focus:outline-none mt-2" />
                            </div>
                            <div class="p-3">
                                <label class="text-sm text-gray-700 font-bold">
                                    E-mail
                                </label>
                                <input type="email" name="email" id="email" placeholder="example@something.com" class="px-2 py-1 bg-white placeholder-gray-700 border-b-4 focus:border-0 focus:outline-none mt-2" />
                            </div>
                        </div>
                    </div>
                </form>
            ...
            {{-- checkout card --}}
            <div class="h-64 w-3/12 bg-white p-8 rounded shadow-2xl">
                checkout card
            </div>
        </div> -->
